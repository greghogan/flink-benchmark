...
public interface DataSetAnalytic<IN, T> {
	 ...
	 * @throws Exception
	 */
	T execute(ExecutionEnvironment env) throws Exception;
	 ...
	 * @throws Exception
	 */
	T execute(ExecutionEnvironment env, String jobName) throws Exception;
	 ...
	 * @throws Exception
	 */
	DataSetAnalytic<IN, T> run(ExecutionEnvironment env, DataSet<IN> input) throws Exception;
}
